...
class Ecommerce_Controller_Admin_Delivery_Options_Rules extends Controller_Admin_Application {
  ...
  public function action_edit($id = FALSE)
	{
		...
		$fields['delivery_options_rule']['price'] = $delivery_options_rule->retail_price();
		
		if ( ! $delivery_options_rule->loaded())
		{
  		$fields['delivery_options_rule']['customer_selectable'] = TRUE;
		}
