...
class Ecommerce_Controller_Trade_Products extends Controller_Trade_Application
{
	public function before()
	{
		if ( ! Caffeine::modules('products'))
		{
			throw new Kohana_Exception('The "products" module is not enabled');
		}
