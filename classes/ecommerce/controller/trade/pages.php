...
class Ecommerce_Controller_Trade_Pages extends Controller_Trade_Application
{
	function before()
	{
		if ( ! Caffeine::modules('pages'))
		{
	...
	{	
		...
		$this->template = Twig::factory('trade/pages/static/'.end($slug_parts), array(), IN_PRODUCTION ? 'production' : 'development');
